...
function introFull() {
	var e = $(".intro-hero-full"),
		r = (e.height(), $(".ms-header").height()),
		t = (r > 0 ? r : 0) + $(".ms-navbar").height();
	e.css("height", $(window).height() - t + "px")
}
handler.apply(window, [" On"]), $(document).ready(introFull), $(window).resize(introFull), $(function () {
	$("#Container").mixItUp();
