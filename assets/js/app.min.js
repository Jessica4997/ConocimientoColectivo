...
$(document).ready(function () {
        ...
        $(window).scroll(function () {
            i || ($(window).scrollTop() > 120 && (n.addClass("shrink"), e.addClass("bd-scroll"), n.addClass("fixed-top")), $(window).scrollTop() < 121 && (n.removeClass("shrink"), e.removeClass("bd-scroll"), n.removeClass("fixed-top")))
    ...
    function (t, o, n) {
        ...
        t.fn.dropdownHover = function (n) {
            return "ontouchstart" in document ? this : (e = e.add(this.parent()), this.each(function () {
                ...
                function u(t) {
                    o.clearTimeout(i), o.clearTimeout(a), a = o.setTimeout(function () {
                        e.find(":focus").blur(), !0 === p.instantlyCloseOthers && e.removeClass("show"), o.clearTimeout(a), s.attr("aria-expanded", "true"), r.addClass("show"), s.trigger(c)
                    }, p.hoverDelay)
                }
                r.hover(function (n) {
                    ...
                    t(o).width() > 767 && (o.clearTimeout(a), i = o.setTimeout(function () {
                        s.attr("aria-expanded", "false"), r.removeClass("show"), s.trigger("hide.bs.dropdown")
                    }, p.delay))
                }), s.hover(function (n) {
                    if (!r.hasClass("show") && !r.is(n.target) && t(o).width() > 767) return !0;
                    t(o).width() > 767 && u(n)
    ...
    function (t) {
        ...
        function n(n) {
            var i = !1;
            (n.is(t.material.options.checkboxElements) || n.is(t.material.options.radioElements)) && (i = !0), n.closest("label").hover(function () {
                var n, e, a = t(this).find("input"),
                    s = a.prop("disabled");
                i && (n = t(this), e = s, (n.hasClass("checkbox-inline") || n.hasClass("radio-inline") ? n : n.closest(".checkbox").length ? n.closest(".checkbox") : n.closest(".radio")).toggleClass("disabled", e)), s || o(a)
            }, function () {
                e(t(this).find("input"))
            })
        }
        ...
        t.expr[":"].notmdproc = function (o) {
            ...
            attachInputEventHandlers: function () {
                ...
                t(document).on("keydown paste", ".form-control", function (o) {
                    ...
                    "" === o.val() ? e.addClass("is-empty") : e.removeClass("is-empty"), n && (i ? e.removeClass("has-error") : e.addClass("has-error"))
    ...
    function (t, o, n, e) {
        ...
        function r(o, n) {
            a = this, this.element = t(o), this.options = t.extend({}, s, n), this._defaults = s, this._name = i, this.init()
        }
                ...
                if (!a.isTouch() || "mousedown" !== e.type) {
                    ...
                    if (s || r) {
                        ...
                        c.addClass("ripple").css({
                            ...
                            top: s,
                            "background-color": l
                        }), i.append(c), o.getComputedStyle(c[0]).opacity, a.rippleOn(n, c), setTimeout(function () {
                            a.rippleEnd(c)
