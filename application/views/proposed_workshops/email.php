                  ...
                  <tr>
                    <td style="padding: 0 16px 0 16px;" align="center" valign="top">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                          <td align="center" style="padding: 0 0 8px 0; color: #c0ca33; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 28px; font-weight: 400; line-height: 32px;">Solicitud de Taller Aperturada</td>
                        </tr>
                        <tr>
                          <td align="center" style="padding: 0 0 16px 0; color: #424242; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 28px;"> Se le informa que su solicitud de taller con nombre: "<?php echo $pw_title?>" ha sido aperturada.</td>
                        </tr>
                        <tr>
                          <td>
                          </td>
