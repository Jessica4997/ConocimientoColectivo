            ...
            <form method="post" action="<?php echo site_url('admin/edit_teacher_rate/' .$iu_id['iu_id'])?>" class="form-horizontal">
              <fieldset>
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-9">
                    <input type="number" class="form-control" name="puntaje_docente" placeholder="Calificación del alumno" min="1" max="5" value="<?php echo $iu_id['iu_tutor_rating']?>" required> </div>
                </div>
