                  ...
                  <tr>
                    <td style="padding: 0 16px 0 16px;" align="center" valign="top">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                          <td align="center" style="padding: 0 0 8px 0; color: #c0ca33; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 28px; font-weight: 400; line-height: 32px;">Recuperar Contraseña</td>
                        </tr>
                        <tr>
                          <td align="center" style="padding: 0 0 16px 0; color: #424242; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 28px;"> Hemos recibido tu solicitud para restablecer tu contraseña, haz click en el siguiente botón para hacerlo</td>
                        </tr>
                        <tr>
                          <td>
                            <!-- Button -->
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td align="center">
                                        <a style="background-color: #c0ca33; border-top: 10px solid #c0ca33; border-right: 22px solid #c0ca33; border-bottom: 8px solid #c0ca33; border-left: 22px solid #c0ca33; display: inline-block; color: #fff; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: normal; line-height: 24px; text-decoration: none; box-shadow: 1px 1px 1px rgba(0,0,0,0.5); text-transform: uppercase;"
                                          href="<?php echo site_url('login/get_token/' .$token)?>" target="_blank">Restablecer Contraseña</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td style="color: #90A4AE; font-family: 'Roboto', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: normal; line-height: 21px;" align="center">
                            <a style="color: #CFD8DC; text-decoration: none;" href="#"> © 2018 Conocimiento Colectivo</a>
                          </td>
                        </tr>
                      </table>
                    </td>
