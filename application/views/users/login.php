<div class="ms-hero-page-override ms-hero-img-city ms-hero-bg-dark-light">
        <div class="container">
          <div class="text-center">
            ...
            <h1 class="no-m ms-site-title color-white center-block ms-site-title-lg mt-2 animated zoomInDown animation-delay-5">Conocimiento<strong>&nbsp;&nbsp;Colectivo</strong>
            </h1>
            <p class="lead lead-lg color-white text-center center-block mt-2 mw-800 text-uppercase fw-300 animated fadeInUp animation-delay-7">Inicia sesión para poder disfrutar de los beneficios que te brinda Conocimiento <strong>&nbsp;Colectivo</strong></p>
          </div>
        </div>
      </div>
      <div class="container">
